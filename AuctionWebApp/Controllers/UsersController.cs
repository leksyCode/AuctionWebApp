...
namespace CustomIdentityApp.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(AuctionIdentityContext context, UserManager<User> userManager)
        {
            db = context;
        ...
        public async Task<IActionResult> ShowPurchases()
        {
            ...
            return View(db.Items.Include(p => p.Owner).Include(b => b.Bets).Where(s => s.PurchasedStatus == true).Where(u => u.Owner.Id == user.Id).ToList());
        }
    }
}